...
public class Scheduling implements Serializable{
	...
	/*
	@ManyToMany
	@JoinTable(name = "tb_scheduling_services",  joinColumns = @JoinColumn(name = "scheduling_id"),inverseJoinColumns = @JoinColumn(name = "barberserv_id"))
	private Set<BarberServ> service = new HashSet<>();
	*/
